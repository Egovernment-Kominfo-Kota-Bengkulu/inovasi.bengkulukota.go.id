        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="/favicon.png" alt="" height="24"> <span class="logo-txt">Inovasi Bengkulu</span>
                    </span>
                </a>
                    ...
                    <form class="p-3">
                        <div class="form-group m-0">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Temukan inovasi..." aria-label="Search Result">
