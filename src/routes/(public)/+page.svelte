...
<div class="row">
    ...
    <div class="col-xl-2 col-md-6" title="Perangkat Daerah, Kecamatan, RSHD, RSTG dan Perumda Tirta Hidayah">
        <!-- card -->
        <div class="card card-h-100">
            <!-- card body -->
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-12">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Perangkat Daerah</span>
                        <h4 class="mb-3">
    ...
    <div class="col-xl-2 col-md-6" title="Kelurahan">
        <!-- card -->
        <div class="card card-h-100">
            <!-- card body -->
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-12">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Kelurahan</span>
                        <h4 class="mb-3">
    ...
    <div class="col-xl-2 col-md-6" title="Puskesmas">
        <!-- card -->
        <div class="card card-h-100">
            <!-- card body -->
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-12">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Puskesmas</span>
                        <h4 class="mb-3">
                            <span class="counter-value" data-target="1257">0</span>
                        </h4>
                    </div>
                </div>
            </div><!-- end card body -->
    ...
    <div class="col-xl-2 col-md-6" title="Sekolah Menengah Pertama">
        <!-- card -->
        <div class="card card-h-100">
            <!-- card body -->
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-12">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Sekolah Menengah Pertama</span>
                        <h4 class="mb-3">
                            <span class="counter-value" data-target="1257">0</span>
                        </h4>
                    </div>
    ...
    <div class="col-xl-2 col-md-6" title="Sekolah Dasar">
        <!-- card -->
        <div class="card card-h-100">
            <!-- card body -->
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-12">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Sekolah Dasar</span>
                        <h4 class="mb-3">
                            <span class="counter-value" data-target="127">0</span>
                        </h4>
                    </div>
                </div>
            </div><!-- end card body -->
